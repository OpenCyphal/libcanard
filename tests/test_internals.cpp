...
TEST_CASE("SessionSpecifier")
{
    REQUIRE(0b000'00'0011001100110011'0'1010101 ==
            internals::txMakeMessageSessionSpecifier(0b0011001100110011, 0b1010101));
    REQUIRE(0b000'11'0100110011'0101010'1010101 ==
            internals::txMakeServiceSessionSpecifier(0b0100110011, true, 0b1010101, 0b0101010));
    REQUIRE(0b000'10'0100110011'1010101'0101010 ==
            internals::txMakeServiceSessionSpecifier(0b0100110011, false, 0b0101010, 0b1010101));
}

TEST_CASE("txGetPresentationLayerMTU")
{
    auto ins = canardInit(&helpers::dummy_allocator::allocate, &helpers::dummy_allocator::free);
    REQUIRE(63 == internals::txGetPresentationLayerMTU(&ins));  // This is the default.
    ins.mtu_bytes = 0;
    REQUIRE(7 == internals::txGetPresentationLayerMTU(&ins));
    ins.mtu_bytes = 255;
    REQUIRE(63 == internals::txGetPresentationLayerMTU(&ins));
    ins.mtu_bytes = 32;
    REQUIRE(31 == internals::txGetPresentationLayerMTU(&ins));
...
{
    using internals::txMakeTailByte;
...
{
    using internals::txRoundFramePayloadSizeUp;
...
{
    using internals::txFindQueueSupremum;
